...
class Predictor:
    ...
    def predict_raw_probability(model_output, properties):
        ...
        # print(f"shape_after_cropping_before_resample is {shape_after_cropping_before_resample}")
    ...
    def predict_noncrop_probability(model_output, properties):
        ...
        if len(model_output.shape) == 3:
            ...
            # print(f"shape_before_cropping is {shape_before_cropping}")
    ...
    def save_to_nii(self, return_output,
        ...
        print(f"writing this case: {case_name}")
